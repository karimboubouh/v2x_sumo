...
INTERNET_QUALITY_THRESHOLD = 0.05     # Min model-based score for internet candidates (default 0.05)
...
# ── Theme ────────────────────────────────────────────────
THEME_MODE = "system"         # "dark", "light", or "system" (auto-detect from macOS appearance)
